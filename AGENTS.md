...
- **Alcance de build:** `docs/pilot-scope-v0.3.1.md` es la única autoridad; sus decisiones posteriores están integradas en el cuerpo. `docs/srs-v0.2.md` es visión, no alcance. `docs/archive/` es historia.
